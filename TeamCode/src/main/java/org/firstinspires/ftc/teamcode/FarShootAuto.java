        ...
        public Paths(Follower follower) {
            ...
            paths[0] = follower.pathBuilder()
                    .addPath(new BezierLine(
                            new Pose(87.117, 7.838),
                            new Pose(132.143, 8.006)
                    ))
            ...
            paths[13] = follower.pathBuilder()
                    .addPath(new BezierLine(
                            new Pose(129.834, 83.960),
                            new Pose(86.566, 9.100)
